...
static int loadCssc132UserConfig(char *filename,struct Cssc132Config *user_config,struct Cssc132Config *config)
{
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            {
                user_config->current_format.width = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp >= 480 && temp <= 1280)
            {
                user_config->current_format.height = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp >= 2 && temp <= 120)
            {
                user_config->current_format.frame_rate = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            {
                user_config->trigger_frame_rate = temp_f;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp <= 4)
            {
                user_config->day_night_mode = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp >= 0 && temp <= 1)
            {
                user_config->exposure_frame_mode = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            user_config->slow_shutter_gain.inter = (unsigned char)temp_f;
            user_config->slow_shutter_gain.dec = (unsigned char)((unsigned int )(temp_f * 10.0f) % 10);
            have_diff = 1;
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp >= 0 && temp <= 2)
            {
                user_config->exposure_mode = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        {
            temp = strtol(temp_buf, &endptr, 10);
            if(temp >= 0 && temp <= (unsigned int)(1000000 / user_config->current_format.frame_rate))
            {
                user_config->manual_exposure_time = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            user_config->manual_exposure_again.inter = (unsigned char)temp_f;
            user_config->manual_exposure_again.dec = (unsigned char)((unsigned int )(temp_f * 10.0f) % 10);
            have_diff = 1;
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            user_config->manual_exposure_dgain.inter = (unsigned char)temp_f;
            user_config->manual_exposure_dgain.dec = (unsigned char)((unsigned int )(temp_f * 10.0f) % 10);
            have_diff = 1;
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp >= 0 && temp <= (unsigned int)(1000000 / user_config->current_format.frame_rate))
            {
                user_config->direct_manual_exposure_time = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            user_config->direct_manual_exposure_again.inter = (unsigned char)temp_f;
            user_config->direct_manual_exposure_again.dec = (unsigned char)((unsigned int )(temp_f * 10.0f) % 10);
            have_diff = 1;
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            user_config->direct_manual_exposure_dgain.inter = (unsigned char)temp_f;
            user_config->direct_manual_exposure_dgain.dec = (unsigned char)((unsigned int )(temp_f * 10.0f) % 10);
            have_diff = 1;
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            {
                user_config->mwb_color_temperature = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp >= 0 && temp <= 3)
            {
                user_config->image_direction = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp >= 0 && temp <= 255)
            {
                user_config->auto_exposure_target_brightness = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            else if(user_config->exposure_frame_mode == 0)
            {
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            user_config->auto_exposure_max_gain.inter = (unsigned char)temp_f;
            user_config->auto_exposure_max_gain.dec = (unsigned char)((unsigned int )(temp_f * 10.0f) % 10);
            have_diff = 1;
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp >= 0 && temp <= 1)
            {
                user_config->hardware_trigger_edge = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp == 0 || temp == 1)
            {
                user_config->hardware_trigger_delete_bouncer_time.enable = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp >= 0)
            {
                user_config->hardware_trigger_delete_bouncer_time.time = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp >= 0)
            {
                user_config->hardware_trigger_delay = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp == 0 || temp == 1)
            {
                user_config->pick_one_mode = temp;
                have_diff = 1;
            }
        }
    }
    ...
    if(pos != 0xFFFF && pos < file_len)
    {
        ...
        if(strlen(temp_buf) != 0 && strlen(temp_buf) < 32)
        {
            ...
            if(temp == 0 || temp == 1)
            {
                user_config->led_strobe_enable = temp;
                have_diff = 1;
            }
        }
    }
