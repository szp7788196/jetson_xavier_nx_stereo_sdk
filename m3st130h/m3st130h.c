...
static int connectCamrea(struct M3st130hConfig *config)
{
    ...
    if(dvp_status != DVP_STATUS_OK || cam_cnt == 0)
    {
        fprintf(stderr,"%s: no camera found[%d]\n",__func__,config->camera_index);
        return -1;
    }

    dvp_status = dvpEnum(config->camera_index, &config->camera_info);
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] info failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: open camera[%d]: %s failed\n",__func__,config->camera_index,config->camera_info.FriendlyName);
        return -1;
    }
...
static void disconnectCamera(struct M3st130hConfig config)
{
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: stop camera[%d] video stream failed\n",__func__,config.camera_index);
    }

    dvp_status = dvpClose(config.camera_handle);
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: close camera[%d] failed\n",__func__,config.camera_index);
    }
}
...
static int loadCameraDefaultConfig(struct M3st130hConfig config,const char *filename)
{
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: load camera[%d] def config failed\n",__func__,config.camera_index);
        return -1;
    }
...
static int queryCameraConfig(struct M3st130hConfig *config)
{
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] auto_exposure_target_brightness failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] analog_gain failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] exposure_time failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] exposure_roi failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] auto_exposure_mode failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] anti_flick failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] auto_exposure_operate_mode failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] auto_exposure_conf_info failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] color_temperature failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] color_temperature_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] saturation failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] saturation_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] awb_roi failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] awb_operate failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] rgb_digital_gain failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] rgb_digital_gain_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] gamma failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] gamma_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] contrast failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] contrast_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] sharpness failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] sharpness_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] noise_reduct_2d failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] noise_reduct_2d_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] noise_reduct_3d failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] noise_reduct_3d_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] black_level failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] black_level_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] mono_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] inverse_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] flip_horizontal_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] flip_vertical_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] rotate_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] rotate_opposite failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] roi failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] roi_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] source_format failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] target_format failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] soft_trigger_loop_time failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] soft_trigger_loop_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] ext_trigger_jitter_filter failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] ext_trigger_delay failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] strobe_delay failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] strobe_duration failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] frames_per_trigger failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] ext_trigger_source failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] trigger_state failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] strobe_driver failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] strobe_output_type failed\n",__func__,config->camera_index);
        return -1;
    }
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr,"%s: get camera[%d] ext_trigger_input_type failed\n",__func__,config->camera_index);
        return -1;
    }
...
static int loadCameraUserConfig(struct M3st130hConfig *def_config,struct M3st130hConfig *user_config,char *filename)
{
    ...
    if(file_buf == NULL)
    {
        fprintf(stderr, "%s: alloc camera[%d] user parameters file buf failed\n",__func__,def_config->camera_index);
        fclose(fp);
		return -1;
    }
...
static int setCameraUserConfig(struct M3st130hConfig *config,struct M3st130hConfig *user_config)
{
    ...
    if(config->auto_exposure_target_brightness != user_config->auto_exposure_target_brightness)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] dvpGetAeTargetDescr failed\n",__func__,config->camera_index);
        }
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] auto_exposure_target_brightness is Illegal,should be (%d~%d) in step:%d\n",
                        __func__,
                        config->camera_index,
                        i_describe.iMin,
                        i_describe.iMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set auto_exposure_target_brightness failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->analog_gain != user_config->analog_gain)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] dvpGetAnalogGainDescr failed\n",__func__,config->camera_index);
        }
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] analog_gain is Illegal,should be (%.3f~%.3f) in step:%.3f\n",
                        __func__,
                        config->camera_index,
                        f_describe.fMin,
                        f_describe.fMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set analog_gain failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->exposure_time != user_config->exposure_time)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] dvpGetExposureDescr failed\n",__func__,config->camera_index);
        }
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] exposure_time is Illegal,should be (%.3f~%.3f) in step:%.3f\n",
                        __func__,
                        config->camera_index,
                        d_describe.fMin,
                        d_describe.fMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set exposure_time failed\n",__func__,config->camera_index);
                }
            }
        }
    }
       ...
       config->exposure_roi.H != user_config->exposure_roi.H)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] exposure_roi is Illegal, "
        ...
        else
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set exposure_roi failed\n",__func__,config->camera_index);
            }
        }
    }
    ...
    if(config->auto_exposure_mode != user_config->auto_exposure_mode)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] auto_exposure_mode is Illegal,should be in range AE_MODE_AE_AG(0) to AE_MODE_AG_ONLY(3)\n",
                   __func__,
                   config->camera_index);
        }
        else
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set auto_exposure_mode failed\n",__func__,config->camera_index);
            }
        }
    }
    ...
    if(config->anti_flick != user_config->anti_flick)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] anti_flick is Illegal,should be in range ANTIFLICK_DISABLE(0) to ANTIFLICK_60HZ(2)\n",
                    __func__,
                    config->camera_index);
        }
        else
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set anti_flick failed\n",__func__,config->camera_index);
            }
        }
    }
    ...
    if(config->auto_exposure_operate_mode != user_config->auto_exposure_operate_mode)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] auto_exposure_operate_mode is Illegal,should be in range AE_OP_OFF(0) to AE_OP_CONTINUOUS(2)\n",
                    __func__,
                    config->camera_index);
        }
        else
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set auto_exposure_operate_mode failed\n",__func__,config->camera_index);
            }
        }
    }
       ...
       config->auto_exposure_conf_info.fGainMax != user_config->auto_exposure_conf_info.fGainMax)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] auto_exposure_conf_info data is Illegal, \n"
        ...
        else
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set auto_exposure_conf_info failed\n",__func__,config->camera_index);
            }
        }
    }
    ...
    if(config->color_temperature != user_config->color_temperature)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] dvpGetColorTemperatureDescr failed\n",__func__,config->camera_index);
        }
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] color_temperature is Illegal,should be (%d~%d) in step:%d\n",
                        __func__,
                        config->camera_index,
                        i_describe.iMin,
                        i_describe.iMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set color_temperature failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->color_temperature_state != user_config->color_temperature_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set color_temperature_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->saturation != user_config->saturation)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] dvpGetSaturationDescr failed\n",__func__,config->camera_index);
        }
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] saturation is Illegal,should be (%d~%d) in step:%d\n",
                        __func__,
                        config->camera_index,
                        i_describe.iMin,
                        i_describe.iMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set saturation failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->saturation_state != user_config->saturation_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set saturation_state failed\n",__func__,config->camera_index);
        }
    }
       ...
       config->awb_roi.H != user_config->awb_roi.H)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] awb_roi is Illegal, "
                    "all the data should be an integer multiple of 2, "
                    "(X + W) should be less than 1280 and (Y + H) should be less than 1024\n",__func__,config->camera_index);
        }
        else
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set awb_roi failed\n",__func__,config->camera_index);
            }
        }
    }
    ...
    if(config->awb_operate != user_config->awb_operate)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] awb_operate is Illegal,should be in range AWB_OP_OFF(0) to AWB_OP_CONTINUOUS(2)\n",
                    __func__,
                    config->camera_index);
        }
        else
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set awb_operate failed\n",__func__,config->camera_index);
            }
        }
    }
    ...
    if(config->red_digital_gain != user_config->red_digital_gain)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] red_digital_gain is Illegal,should be in range 0 to 4\n",__func__,config->camera_index);
        }
        else
        {
    ...
    if(config->green_digital_gain != user_config->green_digital_gain)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] green_digital_gain is Illegal,should be in range 0 to 4\n",__func__,config->camera_index);
        }
        else
        {
    ...
    if(config->blue_digital_gain != user_config->blue_digital_gain)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] blue_digital_gain is Illegal,should be in range 0 to 4\n",__func__,config->camera_index);
        }
        else
        {
    ...
    if(rgb_gain_flag != 0)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set rgb_digital_gain failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->rgb_digital_gain_state != user_config->rgb_digital_gain_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set rgb_digital_gain_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->gamma != user_config->gamma)
    {
        ...
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] gamma is Illegal,should be (%d~%d) in step:%d\n",
                        __func__,
                        config->camera_index,
                        i_describe.iMin,
                        i_describe.iMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set gamma failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->gamma_state != user_config->gamma_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set gamma_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->contrast != user_config->contrast)
    {
        ...
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] contrast is Illegal,should be (%d~%d) in step:%d\n",
                        __func__,
                        config->camera_index,
                        i_describe.iMin,
                        i_describe.iMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set contrast failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->contrast_state != user_config->contrast_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set contrast_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->sharpness != user_config->sharpness)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] dvpGetSharpnessDescr failed\n",__func__,config->camera_index);
        }
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] sharpness is Illegal,should be (%d~%d) in step:%d\n",
                        __func__,
                        config->camera_index,
                        i_describe.iMin,
                        i_describe.iMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set sharpness failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->sharpness_state != user_config->sharpness_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set sharpness_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->noise_reduct_2d != user_config->noise_reduct_2d)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] dvpGetNoiseReduct2dDescr failed\n",__func__,config->camera_index);
        }
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] noise_reduct_2d is Illegal,should be (%d~%d) in step:%d\n",
                        __func__,
                        config->camera_index,
                        i_describe.iMin,
                        i_describe.iMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set noise_reduct_2d failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->noise_reduct_2d_state != user_config->noise_reduct_2d_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set noise_reduct_2d_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->noise_reduct_3d != user_config->noise_reduct_3d)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] dvpGetNoiseReduct3dDescr failed\n",__func__,config->camera_index);
        }
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] noise_reduct_3d is Illegal,should be (%d~%d) in step:%d\n",
                        __func__,
                        config->camera_index,
                        i_describe.iMin,
                        i_describe.iMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set noise_reduct_3d failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->noise_reduct_3d_state != user_config->noise_reduct_3d_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set noise_reduct_3d_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->black_level != user_config->black_level)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] dvpGetBlackLevelDescr failed\n",__func__,config->camera_index);
        }
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] black_level is Illegal,should be (%.3f~%.3f) in step:%.3f\n",
                        __func__,
                        config->camera_index,
                        f_describe.fMin,
                        f_describe.fMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set black_level failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->black_level_state != user_config->black_level_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set black_level_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->mono_state != user_config->mono_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set mono_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->inverse_state != user_config->inverse_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set inverse_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->flip_horizontal_state != user_config->flip_horizontal_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set flip_horizontal_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->flip_vertical_state != user_config->flip_vertical_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set flip_vertical_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->rotate_state != user_config->rotate_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set rotate_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->rotate_opposite != user_config->rotate_opposite)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set rotate_opposite failed\n",__func__,config->camera_index);
        }
    }
       ...
       config->roi.H != user_config->roi.H)
    {
        ...
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] roi is Illegal, "
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set roi failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->roi_state != user_config->roi_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set roi_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->source_format != user_config->source_format)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] source_format is Illegal,should be S_RAW8(0)\n",__func__,config->camera_index);
        }
        else
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set source_format failed\n",__func__,config->camera_index);
            }
        }
    }
    ...
    if(config->target_format != user_config->target_format)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] target_format is Illegal,should be S_RAW8(0)/S_RAW16(4)/S_MONO8(30)/S_MONO16(34)/S_BGR24(14)\n",
                    __func__,
                    config->camera_index);
        }
        else
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set target_format failed\n",__func__,config->camera_index);
            }
        }
    }
    ...
    if(config->soft_trigger_loop_time != user_config->soft_trigger_loop_time)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] dvpGetSoftTriggerLoopDescr failed\n",__func__,config->camera_index);
        }
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] soft_trigger_loop_time is Illegal,should be (%.3f~%.3f) in step:%.3f\n",
                        __func__,
                        config->camera_index,
                        d_describe.fMin,
                        d_describe.fMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set soft_trigger_loop_time failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->soft_trigger_loop_state != user_config->soft_trigger_loop_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set soft_trigger_loop_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->ext_trigger_jitter_filter != user_config->ext_trigger_jitter_filter)
    {
        ...
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] ext_trigger_jitter_filter is Illegal,should be (%.3f~%.3f) in step:%.3f\n",
                        __func__,
                        config->camera_index,
                        d_describe.fMin,
                        d_describe.fMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set ext_trigger_jitter_filter failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->ext_trigger_delay != user_config->ext_trigger_delay)
    {
        ...
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] ext_trigger_delay is Illegal,should be (%.3f~%.3f) in step:%.3f\n",
                        __func__,
                        config->camera_index,
                        d_describe.fMin,
                        d_describe.fMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set ext_trigger_delay failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->strobe_delay != user_config->strobe_delay)
    {
        ...
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] strobe_delay is Illegal,should be (%.3f~%.3f) in step:%.3f\n",
                        __func__,
                        config->camera_index,
                        d_describe.fMin,
                        d_describe.fMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set strobe_delay failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->strobe_duration != user_config->strobe_duration)
    {
        ...
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] strobe_duration is Illegal,should be (%.3f~%.3f) in step:%.3f\n",
                        __func__,
                        config->camera_index,
                        d_describe.fMin,
                        d_describe.fMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set strobe_duration failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->frames_per_trigger != user_config->frames_per_trigger)
    {
        ...
        else
        {
            ...
            {
                fprintf(stderr,"%s: camera[%d] frames_per_trigger is Illegal,should be (%d~%d) in step:%d\n",
                        __func__,
                        config->camera_index,
                        i_describe.iMin,
                        i_describe.iMax,
            ...
            else
            {
                ...
                if(dvp_status != DVP_STATUS_OK)
                {
                    fprintf(stderr,"%s: camera[%d] set frames_per_trigger failed\n",__func__,config->camera_index);
                }
            }
        }
    }
    ...
    if(config->ext_trigger_source != user_config->ext_trigger_source)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] ext_trigger_source is Illegal, "
        ...
        else
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set ext_trigger_source failed\n",__func__,config->camera_index);
            }
        }
    }
    ...
    if(config->trigger_state != user_config->trigger_state)
    {
        ...
        if(dvp_status != DVP_STATUS_OK)
        {
            fprintf(stderr,"%s: camera[%d] set trigger_state failed\n",__func__,config->camera_index);
        }
    }
    ...
    if(config->strobe_driver != user_config->strobe_driver)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] strobe_driver is Illegal, "
        ...
        else
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set strobe_driver failed\n",__func__,config->camera_index);
            }
        }
    }
    ...
    if(config->strobe_output_type != user_config->strobe_output_type)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] strobe_output_type is Illegal, "
        ...
        else
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set strobe_output_type failed\n",__func__,config->camera_index);
            }
        }
    }
    ...
    if(config->ext_trigger_input_type != user_config->ext_trigger_input_type)
    {
        ...
        {
            fprintf(stderr,"%s: camera[%d] ext_trigger_input_type is Illegal, "
        ...
        else
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set ext_trigger_input_type failed\n",__func__,config->camera_index);
            }
        }
    }
    ...
    if(config->trigger_state == true)
    {
        if(config->ext_trigger_source != TRIGGER_SOURCE_SOFTWARE)
        {
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set INPUT_IO_1 to INPUT_FUNCTION_TRIGGER failed\n",__func__,config->camera_index);
                return -1;
            }
            ...
            if(dvp_status != DVP_STATUS_OK)
            {
                fprintf(stderr,"%s: camera[%d] set INPUT_IO_2 to OUTPUT_FUNCTION_STROBE failed\n",__func__,config->camera_index);
                return -1;
            }

            fprintf(stderr,"%s: camera[%d] set external trigger mode success\n",__func__,config->camera_index);
        }
        else
        {
            fprintf(stderr,"%s: camera[%d] now it's software trigger mode\n",__func__,config->camera_index);
        }
    }
    else
    {
        fprintf(stderr,"%s: camera[%d] now it's free run mode\n",__func__,config->camera_index);
    }
...
static int reallocateCameraBuffer(struct M3st130hConfig config)
{
    ...
    if(dvp_status != DVP_STATUS_OK)
    {
        fprintf(stderr, "%s: set camera[%d] buffer queue size failed\n",__func__,config.camera_index);
        return -1;
    }
    ...
    if(imageBuffer[config.camera_index].image == NULL)
    {
        imageBuffer[config.camera_index].image = (char *)malloc(sizeof(char) * config.frame_buf_size);
        if(imageBuffer[config.camera_index].image == NULL)
        {
            fprintf(stderr, "%s: malloc imageBuffer[%d].image failed\n",__func__,config.camera_index);
            return -EAGAIN;
        }
    }
    ...
    ret = allocateImageHeap(config.camera_index,config.image_heap_depth,config.frame_buf_size);
    if(ret != 0)
    {
    ...
    ret = allocateImageUnitHeap(config.camera_index,config.image_heap_depth,config.frame_buf_size);
    if(ret != 0)
    {
...
static int captureImage(struct M3st130hConfig config,unsigned int *image_num)
{
    ...
    {
        fprintf(stderr,"%s: camera[%d] capture image timeout\n",__func__,config.camera_index);
        return -1;
    }
    else
    {
        fprintf(stderr,"%s: camera[%d] capture image failed\n",__func__,config.camera_index);
        return -1;
    }
...
void *thread_m3st130h(void *arg)
{
    ...
    struct M3st130hConfig default_config;
    struct M3st130hConfig user_config;
    ...
    while(1)
    {
        switch((unsigned char)camera_state)
        {
            case (unsigned char)INIT_CONFIG:            //初始化配置
                initCameraConfig(&default_config,args);
            ...
            case (unsigned char)CONNECT_CAMERA:         //链接相机
                ...
                if(ret != 0)
                {
                    fprintf(stderr,"%s: connect camera[%d] failed\n",__func__,user_config.camera_index);
            ...
            case (unsigned char)LOAD_DEFAULT_CONFIG:    //加载默认配置
                ret = loadCameraDefaultConfig(default_config,(const char *)args->m3s_cam_def_conf_file);
                if(ret != 0)
                {
                    fprintf(stderr,"%s: load camera[%d] default config failed\n",__func__,user_config.camera_index);
                    camera_state = DISCONNECT_CAMERA;
                }
                else
                {
            ...
            case (unsigned char)QUERY_CAMERA_CONFIG:    //获取相机配置
                ret = queryCameraConfig(&default_config);
                printCameraConfig(default_config);
                if(ret != 0)
                {
                    fprintf(stderr,"%s: query camera[%d] config failed\n",__func__,user_config.camera_index);
                }
                camera_state = LOAD_USER_CONFIG;
            break;

            case (unsigned char)LOAD_USER_CONFIG:       //加载用户配置
                ret = loadCameraUserConfig(&default_config,&user_config,args->m3s_cam_user_conf_file);
                if(ret != 0)
                {
                    fprintf(stderr,"%s: load camera[%d] user config failed\n",__func__,user_config.camera_index);
            ...
            case (unsigned char)SET_USER_CONFIG:        //设置用户配置
                setCameraUserConfig(&default_config,&user_config);
                printCameraConfig(default_config);
                camera_state = ALLOC_FRAME_BUFFER;
            break;
            ...
            case (unsigned char)ALLOC_FRAME_BUFFER:     //申请帧缓存
                ...
                if(ret != 0)
                {
                    fprintf(stderr,"%s: alloc camera[%d] buffer failed\n",__func__,user_config.camera_index);
                    camera_state = DISCONNECT_CAMERA;
                }
                else
                {
            ...
            case (unsigned char)CAPTURE_IMAGE:          //采集图像
                ...
                if(ret == 0)
                {
                    default_config.capture_failed_cnt = 0;

                    sem_post(&sem_t_ImageHeap[default_config.camera_index]);
                }
                else
                {
                    default_config.capture_failed_cnt ++;

                    if(default_config.capture_failed_cnt >= M3ST130H_MAX_CAPTURE_FAILED_CNT)
                    {
                        camera_state = DISCONNECT_CAMERA;
                    }
                }
