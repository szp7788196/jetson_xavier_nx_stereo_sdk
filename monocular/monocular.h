...
#define KEY_SYNC_CAM_TIME_STAMP_MSG    	1000
#define KEY_CAMERA_RESET_MSG			KEY_SYNC_CAM_TIME_STAMP_MSG + MAX_CAMERA_NUM
#define KEY_IMAGE_HANDLER_MSG			KEY_CAMERA_RESET_MSG + MAX_CAMERA_NUM
#define KEY_UB482_GPGGA_MSG         	KEY_IMAGE_HANDLER_MSG + 1
#define KEY_NTRIP_RTCM_MSG              KEY_IMAGE_HANDLER_MSG + 2
#define KEY_FRAME_RATE_MSG          	KEY_IMAGE_HANDLER_MSG + 3
#define KEY_UB482_TIME_STAMP_MSG    	KEY_IMAGE_HANDLER_MSG + 4
#define KEY_SYNC_MODULE_RESET_MSG		KEY_IMAGE_HANDLER_MSG + 5
#define KEY_IMU_ADS16505_HANDLER_MSG	KEY_IMAGE_HANDLER_MSG + 6
...
extern pthread_cond_t condImageHeap[MAX_CAMERA_NUM];
