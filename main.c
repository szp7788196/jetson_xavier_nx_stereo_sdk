...
int imageHandler_1(struct ImageHeapUnit *image)
{
    int ret = 0;
/* 
 ...
 */
    printf("\r\n");
    printf("======================= image_1 timestamp start =======================\n");
    printf("* 1_image->time_stamp->time_stamp_local : %lf\n",image->time_stamp->time_stamp_local);
    printf("* 1_image->time_stamp->time_stamp_gnss  : %lf\n",image->time_stamp->time_stamp_gnss);
    printf("* 1_image->time_stamp->counter          : %d\n",image->time_stamp->counter);
    printf("* 1_image->image->counter               : %d\n",image->image->counter);
    printf("======================== image_1 timestamp end ========================\n");

    return ret;
}

int imageHandler_2(struct ImageHeapUnit *image)
{
    int ret = 0;
/* 
    ret = imageBufCompressToJpeg("/home/szp/test_image.jpg",80,(unsigned char *)image->image->image,1280,720,1);
 ...
 */
    printf("\r\n");
    printf("======================= image_2 timestamp start =======================\n");
    printf("* 2_image->time_stamp->time_stamp_local : %lf\n",image->time_stamp->time_stamp_local);
    printf("* 2_image->time_stamp->time_stamp_gnss  : %lf\n",image->time_stamp->time_stamp_gnss);
    printf("* 2_image->time_stamp->counter          : %d\n",image->time_stamp->counter);
    printf("* 2_image->image->counter               : %d\n",image->image->counter);
    printf("======================== image_2 timestamp end ========================\n");
...
int main(int argc, char **argv)
{
    ...
    image_handler[0] = imageHandler_1;
    image_handler[1] = imageHandler_2;
    image_handler[2] = NULL;

    monocular_sdk_register_handler(image_handler,NULL,NULL,NULL);
