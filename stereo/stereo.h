...
#define KEY_SYNC_MODULE_RESET_MSG		KEY_CAMERA_RESET_MSG + MAX_CAMERA_NUM + 0
#define KEY_IMAGE_HANDLER_MSG			KEY_CAMERA_RESET_MSG + MAX_CAMERA_NUM + 1
#define KEY_IMU_ADS16505_HANDLER_MSG	KEY_CAMERA_RESET_MSG + MAX_CAMERA_NUM + 2
#define KEY_IMU_MPU9250_HANDLER_MSG		KEY_CAMERA_RESET_MSG + MAX_CAMERA_NUM + 3
#define KEY_GNSS_UB482_HANDLER_MSG		KEY_CAMERA_RESET_MSG + MAX_CAMERA_NUM + 4
#define KEY_SYNC_1HZ_SUCCESS_MSG		KEY_CAMERA_RESET_MSG + MAX_CAMERA_NUM + 5
...
extern struct ImageBuffer imageBuffer[MAX_CAMERA_NUM];
extern struct ImageHeap imageHeap[MAX_CAMERA_NUM];
extern struct ImageUnitHeap imageUnitHeap[MAX_CAMERA_NUM];
extern struct SyncCamTimeStampHeap syncCamTimeStampHeap[MAX_CAMERA_NUM];

extern pthread_mutex_t mutexImageHeap[MAX_CAMERA_NUM];
extern pthread_mutex_t mutexImageUnitHeap[MAX_CAMERA_NUM];
extern pthread_mutex_t mutexSyncCamTimeStampHeap[MAX_CAMERA_NUM];
extern sem_t sem_t_ImageHeap[MAX_CAMERA_NUM];
extern sem_t sem_t_ImageUnitHeap[MAX_CAMERA_NUM];
extern sem_t sem_t_SyncCamTimeStampHeap[MAX_CAMERA_NUM];
